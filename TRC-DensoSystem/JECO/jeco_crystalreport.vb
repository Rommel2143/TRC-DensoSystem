...
Public Class jeco_crystalreport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TRC_Denso_System.jeco_crystalreport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedjeco_crystalreport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As jeco_crystalreport = New jeco_crystalreport()
        rpt.Site = Me.Site
        Return rpt
    End Function
