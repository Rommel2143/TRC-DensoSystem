...
Public Class retainer_3t_rpt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TRC_Denso_System.retainer_3t_rpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedretainer_3t_rpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As retainer_3t_rpt = New retainer_3t_rpt()
        rpt.Site = Me.Site
        Return rpt
    End Function
