...
Public Class intelli4_rpt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TRC_Denso_System.intelli4_rpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedintelli4_rpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As intelli4_rpt = New intelli4_rpt()
        rpt.Site = Me.Site
        Return rpt
    End Function
