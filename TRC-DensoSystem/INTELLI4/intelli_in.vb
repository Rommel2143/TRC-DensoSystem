...
Public Class intelli_in
            ...
            If txtqr_verify.Text = txtqr_label.Text Then
                Try
                    ...
                    If processQRcode("INT4", txtqr_label) Then
                        con.Close()
                        con.Open()
                        Dim cmdselect As New MySqlCommand("SELECT intelliqr, userin, datein,status FROM `denso_intelli4`
    ...
    Private Sub saveqr()
        Try
            ...
            Dim insertjeco As New MySqlCommand("INSERT INTO `denso_intelli4`(`intelliqr`,
                                                                            `partno`,
                                                                            `customerno`,
                                                                            `color`,
                                                                            `proddate`,
